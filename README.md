...
## Sample Input & Output
- 🧪 Input: DNA Sequence, e.g. ATCG  
- 🔄 Process: The sequence is encoded and passed to the backend for variation prediction.  
- 📊 Output: Variation values (4 floats) displayed as a bar chart showing genetic variation frequencies.
